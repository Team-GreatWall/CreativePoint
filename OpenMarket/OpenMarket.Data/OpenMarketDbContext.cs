namespace OpenMarket.Data
{
    ...
    public class OpenMarketDbContext : IdentityDbContext<User>
        {
            public OpenMarketDbContext()
                : base("OpenMarketDb", throwIfV1Schema: false)
            {
                Database.SetInitializer(new MigrateDatabaseToLatestVersion<OpenMarketDbContext ,OpenMarket.Data.Migrations.Configuration>());
            }
